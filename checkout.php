  ...
  ?>
    ...
    <div class="row">
      ...
      <div class="col-md-6 p-3">
        <h4 class="font-weight-bold">Shipping Detail</h4>
        <hr>
        ...
        <form method="post" class="mt-4">
          <div class="form-group">
            ...
            <input type="text" name="fullname" placeholder="Full Name" class="form-control p-2 px-2 hover-effect" value="<?php echo $customer_name; ?>" required>
          </div>

          <div class="form-group">
            <label for="address">Address:</label>
            <input type="text" name="address" placeholder="Address" value="<?php echo $customer_add; ?>" class="form-control p-2 px-2 hover-effect">
          </div>
          ...
          <div class="row">
            <div class="col-md-6 col-6">
              <div class="form-group">
                ...
                <input type="text" name="city" placeholder="City" class="form-control p-2 px-2 hover-effect" value="<?php echo $customer_city; ?>" required>
              </div>
            </div>
            ...
            <div class="col-md-6 col-6">
              <div class="form-group">
                ...
                <input type="number" name="code" placeholder="Postal code" class="form-control p-2 px-2 hover-effect" value="<?php echo $customer_pcode; ?>" required>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="phone_number" placeholder="Phone Number" class="form-control p-2 px-2 hover-effect" value="<?php echo $customer_number; ?>" required>
          </div>

          <div class="form-group text-center mt-4">
            <input type="submit" name="checkout" class="btn btn-primary btn-block p-2 hover-effect" value="Place Order" id="border-less">
          </div>
        </form>
      </div>
      <!--end cart--->
      ...
      <div class="col-md-6 p-3">
        ...
        <table class="table table-responsive table-hover ">
          <h4 class="font-weight-bold">Order Detail</h4>
          <hr>

    ...
    <div class="col-md-9">
      ...
      <form method="post" class="w-50">
        ...
        <div class="form-group">
          ...
          <input type="text" name="old_pass" placeholder="Old Password" class="form-control p-2 px-2">
        </div>

        <div class="form-group">
          <label>New Password: *</label>
          <input type="text" name="new_pass" placeholder="New Password" class="form-control p-2 px-2">
        </div>

        <div class="form-group">
          <label>Cofirm Password: *</label>
          <input type="text" name="conf_pass" placeholder="Confirm Password" class="form-control p-2 px-2">
        </div>

        <div class="form-group text-center mt-4">
          <input type="submit" name="update" class="btn btn-primary col-md-6" value="Update">
        </div>

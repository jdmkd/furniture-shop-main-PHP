    ...
    <div class="col-md-9">
      ...
      <form method="post" class="w-75">
        ...
        <div class="form-group p-2">
          <input type="text" name="fullname" placeholder="Full Name" value="<?php echo $cust_name; ?>" class="form-control hover-effect p-2 px-2">
        </div>
        ...
        <div class="form-group p-2">
          <input type="text" name="address" placeholder="Address" value="<?php echo $cust_add; ?>" class="form-control hover-effect p-2 px-2">
        </div>

        <div class="row">
          <div class="col-md-6 col-6">
            <div class="form-group p-2">
              <input type="text" name="city" placeholder="City" value="<?php echo $cust_city; ?>" class="form-control hover-effect p-2 px-2">
            </div>
          </div>

          <div class="col-md-6 col-6">
            <div class="form-group p-2">
              <input type="number" name="code" placeholder="Postal code" value="<?php echo $cust_pcode; ?>" class="form-control hover-effect p-2 px-2">
            </div>
          </div>
        ...
        <div class="form-group p-2">
          <input type="number" name="phone_number" placeholder="Phone Number" value="<?php echo $cust_number; ?>" class="form-control hover-effect p-2 px-2">
        </div>

        <div class="form-group text-center mt-4">
          <input type="submit" name="update" class="btn btn-primary col-md-5 hover-effect" value="Update">
        </div>

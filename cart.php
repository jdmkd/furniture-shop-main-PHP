...
?>
    ...
    <div class="container mb-5 p-5 border rounded">
      ...
      <div class="container ">
        ...
        <div class="row">
          <div class="col-md-5 col-6 text-left">
            <a href="product.php">
              <input class="btn btn-primary pt-2 pb-2" type="button" style="font-size:1rem;" value="Continue Shopping">
            </a>
          </div>
          <div class="col-md-7 col-6 text-right">
            <a href="checkout.php">
              <input type="button" name="proceed" value="Proceed checkout" style="font-size:1rem;" class="btn btn-success pt-2 pb-2">
            </a>
          </div>
        </div>
      </div>

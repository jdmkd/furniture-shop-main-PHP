  ...
  <header id="site-header" class="fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
      ...
      <a href="index.php" class="navbar-brand">
        Online <sapn class="font-weight-bold">Furniture</sapn> Shop
      </a>
      ...
      <div class="collapse navbar-collapse" id="collapisblenav">
        <ul class="navbar-nav ml-auto">
          ...
          ?>
            ...
            <li class="nav-item mr-1"><a class="nav-link" href="register.php"><button type="button" class="btn btn-primary wave-effect btn-sm pl-3 pr-3 "> Register</button></a></li>
          <?php
          }
          ...
          ?>
            <li class="nav-item ml-3"><a class="nav-link" href="customer/index.php"><i class="far fa-user top-icon"></i> Account</a></li>
          <?php }
          ?>
